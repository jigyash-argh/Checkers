          ...
          <div className="p-6 md:p-10 space-y-8 text-white">
            ...
            <section className="bg-[#1a1916]/60 p-6 rounded-lg hover:shadow-[0_0_15px_rgba(251,191,36,0.2)] transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { name: 'Frontend', items: ['React 19', 'Tailwind CSS 4', 'Vite 6', 'Axios', 'React Router 7'] },
                  { name: 'Backend', items: ['Node.js', 'Express', 'MongoDB Atlas', 'JWT Authentication', 'Socket.io'] },
                  { name: 'DevOps', items: ['GitHub', 'NPM', 'Concurrently', 'Nodemon', 'ESLint'] }
                ].map((tech, index) => (
            ...
            <section className="bg-[#1a1916]/60 p-6 rounded-lg hover:shadow-[0_0_15px_rgba(251,191,36,0.2)] transition-all duration-300">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-lg md:text-xl">
                    If you have questions or feedback about this application, please contact me at <a href="mailto:231030151@juitsolan.in" className="text-amber-400 hover:text-amber-300 underline decoration-dotted underline-offset-4 hover:decoration-solid transition-all">231030151@juitsolan.in</a>.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-[#1a1916]/60 p-6 rounded-lg hover:shadow-[0_0_15px_rgba(251,191,36,0.2)] transition-all duration-300">
              ...
              <p className="text-lg md:text-xl">
                ...
                Contact us at <a href="mailto:info@checkgate.com" className="text-amber-400 hover:text-amber-300 underline decoration-dotted underline-offset-4 hover:decoration-solid transition-all">info@checkgate.com</a>.
              </p>
            </section>
          </div>
        </div>
